...
const UpdateCategories = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(`http://143.110.234.115/api/categories/find/${id}`);
  ...
  const updateData = async (updatedData) => {
    try {
      ...
      const response = await axios.put(`http://143.110.234.115/api/categories/${id}`, updatedData, {
        headers: {
